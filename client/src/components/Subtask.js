...
function Subtask({ index, taskIndex, colIndex, subtask, changeSubtaskStatus }) {
  ...
  // let checked = subtask.is_completed;

  const [checked, setChecked] = useState(subtask.is_completed);
  ...
  const onChange = () => {
    setChecked(!checked);
    changeSubtaskStatus(subtask.id);
  }
